...
const schema = yup.object({
  ...
  email2: yup.string().oneOf([yup.ref("email")], "Email does not match!").required("Please confirm email."),
       ...
       <MDBRow className='d-flex justify-content-center'>
        <MDBCol sm="12" lg="10" xxl='7'>
          ...
          <div className='d-flex flex-column justify-content-center h-custom-2 w-75 pt-4'>
            ...
            <MDBRow>
                <MDBCol col='6'>
                  <MDBInput wrapperClass='mx-5 w-100' label='First name' type='text' autoComplete="off" name='fname' {...register("fname")}/>
                  <p className='form-err-msg mx-5 w-100'>{errors.fname?.message}</p>
                </MDBCol>
                <MDBCol col='6'>
                  <MDBInput wrapperClass='mx-5 w-100' label='Last name' type='text' autoComplete="off" name='lname' {...register("lname")}/>
                  <p className='form-err-msg mx-5 w-100'>{errors.lname?.message}</p>
                </MDBCol>
            </MDBRow>

            <MDBInput wrapperClass='mt-2 mx-5 w-100' label='Email' id='form3' autoComplete="off" {...register("email")}/>
            <p className='form-err-msg mx-5 w-100'>{errors.email?.message}</p>

            <MDBInput wrapperClass='mt-4 mx-5 w-100' label='Confirm Email' id='form4' autoComplete="off" {...register("email2")}/>
            <p className='form-err-msg mx-5 w-100'>{errors.email2?.message}</p>

            <MDBInput wrapperClass='mt-4 mx-5 w-100' label='Password' id='form5' autoComplete="off" type='password' {...register("password")}/>
            <p className='form-err-msg mx-5 w-100'>{errors.password?.message}</p>

            <MDBInput wrapperClass='mt-4 mx-5 w-100' label='Confirm Password' id='form6' autoComplete="off" type='password' {...register("password2")}/>
            ...
            {checkTerms
            ? <MDBBtn className="mb-4 px-5 mx-5 w-100 custom-btn" size='lg'>Sign Up</MDBBtn>
            : <MDBBtn className="mb-4 px-5 mx-5 w-100 custom-btn" size='lg' disabled>Sign Up</MDBBtn>
            }
            </form>
